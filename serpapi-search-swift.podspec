#
#  Be sure to run `pod spec lint serpapi-search-swift.podspec' to ensure this is a
...
The package allows seamless integration of [SerpApi](https://serpapi.com) in ios, macOS ...
  ...
  spec.homepage     = "https://github.com/serpapi/serpapi-search-swift"
  ...
  spec.author             = { "Victor Benarbia" => "victor@serpapi.com" }
  # Or just: spec.author    = "Victor Benarbia"
  # spec.authors            = { "Victor Benarbia" => "victor@serpapi.com" }
  # spec.social_media_url   = "https://twitter.com/Victor Benarbia"
